...
urlpatterns = [
    ...
    path("rapida/<uuid:pk>/restaurar/", views.restaurar_avaliacao_rapida, name="restaurar_avaliacao_rapida"),
    path("rapida/<uuid:pk>/criterios/", views.criterios_rapida, name="criterios_rapida"),
    path("rapida/<uuid:pk>/reavaliar/", views.reavaliar_rapida, name="reavaliar_rapida"),
]
